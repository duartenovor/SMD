 ...
 * @return 
 */
int CDatabase::get(std::string table, std::string data, std::string& d_text){

   zErrMsg = 0;

   std::string query = "SELECT " + data + " FROM " + table + ";";
   ...
   if( rc != SQLITE_OK )
   {
      ...
      std::cerr << "Data returned successfully!" << std::endl << std::endl;
