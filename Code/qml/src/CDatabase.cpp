...
CDatabase::CDatabase()
{
   ...
   rc = sqlite3_exec(db, "PRAGMA foreign_keys = ON;", callbackInsert, 0, &zErrMsg);
   ...
   rc = sqlite3_exec(db, tables.c_str(), callbackInsert, 0, &zErrMsg);
 ...
 */
int CDatabase::callbackInsert(void *NotUsed, int count, char **data, char **columns){
...
int CDatabase::callbackReceive(void *NotUsed, int count, char **data, char **columns){
...
int CDatabase::insert(std::string table, std::string values)
{
   ...
   rc = sqlite3_exec(db, query.c_str(), callbackInsert, 0, &zErrMsg);
...
int CDatabase::getLastInserted(std::string table, std::string column, std::string order_by, std::string& d_text){
   ...
   rc = sqlite3_exec(db, query.c_str(), callbackReceive, 0, &zErrMsg);
...
int CDatabase::getTotalElements(std::string table, std::string& d_text){
