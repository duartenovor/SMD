...
class CDatabase
{
    ...
    private:
        ...
        int getTotalElements(std::string table, std::string& d_text);
        ...
        static int callbackInsert(void *NotUsed,int count,char **data,char **columns);
        static int callbackReceive(void *NotUsed,int count,char **data,char **columns);
